...
The heatmap shows genes between the control (left 1-3) and treatment (right, 1-3) samples which correlate in expression. Looking across columns, genes which are both dark green indicate high co-expression. For example, **Myom1, Jph2, and Kcmab1** have high co-expression in the control samples but low co-expression in the treatment samples. This indicates a change in expression once the treatment is applied to the cell cultures. In contrast, **Adamts8, Batf3, and Adra1d** have low co-expression in the control samples but high co-expresion in the treatment samples, which indicates the treatment causes a change in expression for these genes that acts *simultaneously.* 
